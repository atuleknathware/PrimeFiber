        ...
        <div className="boxes-container">
          <div className="box">
            <p>
              ...
              can quickly access and process large amounts of data, enabling
              them to provide you with more accurate and personalized responses
              to user queries.
            </p>
          </div>
          <div className="box">
            <p>
              ...
              <br />
              Transform your home with Prime fiber internet’s fast, reliable,
              and secure connectivity for smart home automation and personalized
              living.
            </p>
          </div>
          <div className="box">
          ...
          <div className="box">
            <p>
              ...
              <br />
              Experience lightning-fast internet with PrimeFiber Stream,
              Connect, Play multi level games online with Prime fiber that never
              slows down.
            </p>
          </div>
          <div className="box">
            <p>
              ...
              <br />
              With faster internet speeds from PrimeFiber, virtual assistants
              can quickly access and process large amounts of data, enabling
              them to provide you with more accurate and personalized responses
              to user queries
            </p>
